...
#define PanSource	"assignment4.pml"
...
#define _nstates7	14	/* never_0 */
#define minseq7	258
#define maxseq7	270
#define _endstate7	13

#define _nstates6	78	/* onPacketReceive */
#define minseq6	181
#define maxseq6	257
#define _endstate6	77

#define _nstates5	31	/* receive */
#define minseq5	151
#define maxseq5	180
#define _endstate5	30

#define _nstates4	23	/* failureDetector */
#define minseq4	129
#define maxseq4	150
#define _endstate4	22

#define _nstates3	29	/* esbTimeSlot */
#define minseq3	101
#define maxseq3	128
#define _endstate3	28

#define _nstates2	48	/* send */
#define minseq2	54
#define maxseq2	100
#define _endstate2	47

#define _nstates1	20	/* startTimer */
#define minseq1	35
#define maxseq1	53
#define _endstate1	19

#define _nstates0	36	/* :init: */
#define minseq0	0
#define maxseq0	34
...
struct EsbPacket { /* user defined type */
	int processId;
	struct Message msg;
};
struct commonKnowledge { /* user defined type */
	uchar member[4];
};
typedef struct P7 { /* never_0 */
...
#define PonPacketReceive	((P6 *)this)
typedef struct P6 { /* onPacketReceive */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
	...
	int m;
	int n;
	struct EsbPacket receivedPacket;
} P6;
#define Air6	0

#define Preceive	((P5 *)this)
typedef struct P5 { /* receive */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define PfailureDetector	((P4 *)this)
typedef struct P4 { /* failureDetector */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air4	(sizeof(P4) - Offsetof(P4, m) - 1*sizeof(int))

#define PesbTimeSlot	((P3 *)this)
typedef struct P3 { /* esbTimeSlot */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air3	(sizeof(P3) - Offsetof(P3, processID) - 1*sizeof(uchar))

#define Psend	((P2 *)this)
typedef struct P2 { /* send */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#endif
	uchar senderID;
	struct EsbPacket sendPacket;
} P2;
#define Air2	0

#define PstartTimer	((P1 *)this)
typedef struct P1 { /* startTimer */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, _17_4_p) - 1*sizeof(int))
...
typedef struct State {
	...
	#endif
#endif
	unsigned tranmission_state : 1;
	uchar commonKnowledgeState[4];
	uchar currentSlot;
	uchar tioa_tdma_state;
	uchar timer_tick;
	uchar P0P1;
	uchar P0P2;
	uchar P0P3;
	...
	struct commonKnowledge ck[4];
	struct EsbPacket controlPacket[4];
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar numberOfNodes;
/* hidden variable: */	uchar members;
