...
#define _nstates6	78	/* onReceive */
#define minseq6	146
#define maxseq6	222
#define _endstate6	77

#define _nstates5	19	/* receive */
#define minseq5	128
#define maxseq5	145
...
#define _nstates3	31	/* esbTimeSlot */
#define minseq3	76
#define maxseq3	105
#define _endstate3	30

#define _nstates2	29	/* send */
#define minseq2	48
#define maxseq2	75
#define _endstate2	28

#define _nstates1	13	/* startTimer */
#define minseq1	36
#define maxseq1	47
#define _endstate1	12

#define _nstates0	37	/* :init: */
#define minseq0	0
#define maxseq0	35
...
#define PonReceive	((P6 *)this)
typedef struct P6 { /* onReceive */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	#endif
#endif
	unsigned transmission_state : 1;
	uchar commonKnowledgeState[3];
	uchar currentSlot;
	...
	int myId;
	struct commonKnowledge ck[3];
	struct EsbPacket controlPacket[3];
#ifdef TRIX
